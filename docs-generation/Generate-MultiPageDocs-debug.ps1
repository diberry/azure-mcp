...
try {
    ...
    Push-Location "..\core\src\AzureMcp.Cli"
    ...
    Write-Host "Arguments passed to the C# generator: $($generatorArgs -join ' ')"
    exit 0 # Stop execution after printing the arguments
